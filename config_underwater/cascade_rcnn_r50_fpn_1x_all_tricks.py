...
train_pipeline = [
    ...
    dict(type='MixUp',p=0.5, lambd=0.5), #引入mixup
    ...
    dict(
        ...
        img_scale=[(4096, 600), (4096, 1400)], #增大scale训练
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(4096, 600), (4096, 1000), (4096, 1400)], #原来 (4096, 1000)
        flip=True, #测试时是否翻转图片
        transforms=[
...
data = dict(
    ...
    train=dict(
        ...
        dataset = dict(
            type=dataset_type,
            ann_file=data_root + 'annotations/instances_train0410.json',
...
log_level = 'INFO'
work_dir = '../data/work_dirs/cascade_rcnn_r50_fpn_1x_all_tricks'
load_from = '../data/work_dirs/cascade_rcnn_r50_fpn_1x_mixup_gc/latest.pth' #加载效果更好的 原始/增广模型
resume_from = None
workflow = [('train', 1)]