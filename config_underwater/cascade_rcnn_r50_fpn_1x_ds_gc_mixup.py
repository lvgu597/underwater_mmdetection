...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/Duck_inject_small.json',
...
log_level = 'INFO'
work_dir = '../data/work_dirs/cascade_rcnn_r50_fpn_1x_ds_gc_mixup'
load_from = '../data/work_dirs/cascade_rcnn_r50_fpn_1x_mixup_gc/latest.pth' #加载预训练网络参数
resume_from = '../data/work_dirs/cascade_rcnn_r50_fpn_1x_ds_gc_mixup/latest.pth'
workflow = [('train', 1)]