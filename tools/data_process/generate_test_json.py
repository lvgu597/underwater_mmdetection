...
def save(images, annotations):
    ...
    json.dump(ann, open('test0702.json', 'w'), indent = 4, separators=(',', ': '))


def test_dataset(im_dir):
    im_list = glob(os.path.join(im_dir, '*.tif'))
    idx = 1
    image_id = 1
    images = []
    annotations = []
...
if __name__ == '__main__':
    test_dir = '../../coco_data/test/TIFFImages'
